...
template <class key_t, class val_t, bool seq, size_t max_model_n>
double Group<key_t, val_t, seq, max_model_n>::mean_error_est() const {
...
template <class key_t, class val_t, bool seq, size_t max_model_n>
double Group<key_t, val_t, seq, max_model_n>::get_mean_error() const {
  double mean_err = 0;
...
Group<key_t, val_t, seq, max_model_n>
  ...
  new_group->data = data;
  new_group->init_models(model_n + 1, prefix_len, feature_len);
...
Group<key_t, val_t, seq, max_model_n>
  ...
  // we can reuse previous model
  new_group_1->model_info = model_info;
  new_group_2->model_info = model_info;
  new_group_1->model_n = model_n;
  new_group_2->model_n = model_n;
  new_group_1->prefix_len = prefix_len;
  new_group_2->prefix_len = prefix_len;
  new_group_1->feature_len = feature_len;
  new_group_2->feature_len = feature_len;
...
template <class key_t, class val_t, bool seq, size_t max_model_n>
inline double *Group<key_t, val_t, seq, max_model_n>::get_model(
